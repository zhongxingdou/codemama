...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { answer: @faq.answer, question: @faq.question, title: @faq.title, user_id: @faq.user_id }
    end
  ...
  test "should update faq" do
    put :update, id: @faq, faq: { answer: @faq.answer, question: @faq.question, title: @faq.title, user_id: @faq.user_id }
    assert_redirected_to faq_path(assigns(:faq))
  end
